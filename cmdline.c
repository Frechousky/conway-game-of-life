...
const char *gengetopt_args_info_usage = "Usage: gameoflife [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Run a randomly initialized Conway's Game of Life.";
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->display_time_given)
      ...
      switch (c)
        ...
        case 'h':	/* Grid height.  */
          ...
          if (update_arg( (void *)&(args_info->height_arg), 
              ...
              &(local_args_info.height_given), optarg, 0, "10", ARG_INT,
              check_ambiguity, override, 0, 0,
              "height", 'h',
              additional_error))
            goto failure;
          ...
          break;
        case 'd':	/* Display time of a single iteration in seconds.  */
        
        
          if (update_arg( (void *)&(args_info->display_time_arg), 
               &(args_info->display_time_orig), &(args_info->display_time_given),
              &(local_args_info.display_time_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "display_time", 'd',
              additional_error))
            goto failure;
